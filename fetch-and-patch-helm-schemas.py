...
Usage: python3 fetch-and-patch-helm-schemas.py [--debug] [repo-root] [schema-dir]

Defaults:
  repo-root:  current directory
  schema-dir: ./values-schemas
"""
...
def main():
    ...
    parser.add_argument("schema_dir", nargs="?", default="./values-schemas", help="Schema output directory (default: ./values-schemas)")
    ...
    chart_files = fetch_all(repo_root, schema_dir)
    ...
    for values_schema in schema_dir.rglob("helmrelease.schema.json"):
        ...
        schema_rel = str(values_schema.relative_to(repo_root))
        ...
        if matched_file:
            file_rel = str(matched_file.relative_to(repo_root))
